    ...
    <main id="main">
        ...
        <section id="contact" class="contact">
            <div class="container" data-aos="fade-up">
                <h1>Form Pesanan Elf</h1>

                <div class="row gy-4 mt-1">

                    <div class="col-lg-8">
                        <form action="/tbh-pesanan-elf" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <div class="mt-3 form-group">
                                ...
                                <input type="text" name="category" class="form-control" id="category" value="Elf"
                                    readonly>
                            </div>
                            <div class="mt-3 form-group">
