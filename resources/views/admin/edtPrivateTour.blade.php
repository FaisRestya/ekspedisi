...
@section('admin')
    <div class="container-fluid px-4">
        <h1 class="mt-4">Edit Private Tour</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Edit Pesanan Private Tour</li>
        </ol>
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="/edt-private-tour/{{ $dftPrivateTour->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label class="mb-2" for="startDate">Dari Tanggal</label>
                            <input type="date" name="startDate" class="form-control" id="startDate" value="{{ date('Y-m-d', strtotime($dftPrivateTour->startDate)) }}" required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="mb-2" for="endDate">Sampai Tanggal</label>
                            <input type="date" name="endDate" class="form-control" id="endDate" value="{{ date('Y-m-d', strtotime($dftPrivateTour->endDate)) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 form-group">
                        ...
                        <select class="form-control" name="tipe" id="tipe">
                            ...
                            @if ($dftPrivateTour->tipe == "ShortElf")
                    ...
                    <div class="mt-3 form-group">
                        ...
                        <input type="number" name="harga" class="form-control" id="harga" value="{{ $dftPrivateTour->harga }}" readonly required>
                    </div>
                    <div class="mt-3 form-group">
                        <label class="mb-2" for="tujuan">Tujuan</label>
                        <input type="text" name="tujuan" class="form-control" value="{{ $dftPrivateTour->tujuan }}" id="tujuan" required>
                    </div>
                    <div class="mt-3 form-group">
                        <label class="mb-2" for="jmlOrang">Jumlah Penumpang</label>
                        <input type="number" name="jmlOrang" class="form-control" id="jmlOrang" value="{{ $dftPrivateTour->jmlOrang }}" required>
                    </div>
                    <div class="mt-3 form-group">
                        <label class="mb-2" for="konsumen">Nama Booking</label>
                        <input type="text" name="konsumen" class="form-control" id="konsumen" value="{{ $dftPrivateTour->konsumen }}" required>
                    </div>
                    <div class="mt-3 form-group">
                        <label class="mb-2" for="phoneNumber">Nomer Telefon</label>
                        <input type="text" name="phoneNumber" class="form-control" id="phoneNumber" value="{{ $dftPrivateTour->phoneNumber }}" required>
                    </div>
                    <div class="mt-3 form-group">
                        <label class="mb-2" for="alamat">Alamat</label>
                        <input type="text" name="alamat" class="form-control" id="alamat" value="{{ $dftPrivateTour->alamat }}" required>
                    </div>
                    <div class="mt-3 form-group">
