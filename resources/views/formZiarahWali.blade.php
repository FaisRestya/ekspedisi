    ...
    <main id="main">
        ...
        <section id="contact" class="contact">
            <div class="container" data-aos="fade-up">
                <h1>Form Ziarah Wali</h1>

                <div class="row gy-4 mt-1">

                    <div class="col-lg-8">
                        <form action="/tbh-ziarah-wali" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <div class="mt-3 form-group">
                                <label class="mb-2" for="konsumen">Nama Instansi</label>
                            ...
                            <div class="mt-3 form-group">
                                <label class="mb-2" for="alamat">Alamat Instansi</label>
